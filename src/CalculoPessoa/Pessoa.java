...
public class Pessoa {
	...
	//dentro dos parênteses são variáveis temporárias
	//método// Construtor
	...
	public void calculaImc() {
		//Altura elevado a 2 = altura multiplicado por altura;
		this.imc = this.massa / (this.altura * this.altura);
		//Equivalencia de matemática altura elevado a 2 , 
